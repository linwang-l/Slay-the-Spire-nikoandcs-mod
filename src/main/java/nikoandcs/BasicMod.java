...
import nikoandcs.relics.BaseRelic;
import nikoandcs.util.GeneralUtils;
import nikoandcs.util.KeywordInfo;
import nikoandcs.util.Sounds;
import nikoandcs.util.TextureLoader;
...
public class BasicMod implements
    ...
    public void receiveEditCards() {
        new AutoAdd(modID) // 加载你 Mod 里的文件
                .packageFilter(BaseCard.class) // 寻找和 BaseCard 在同一个包里的卡牌
                .setDefaultSeen(true) // 把它们标记为“在图鉴中已解锁/已见过”
                .cards(); // 自动把这些卡牌加进游戏
    }
