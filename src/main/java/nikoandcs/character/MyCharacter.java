...
import nikoandcs.relics.Shrimp;

import java.util.ArrayList;

import static nikoandcs.BasicMod.characterPath;
...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Niko"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(nikoandcs.cards.Strike.ID);
        retVal.add(nikoandcs.cards.Strike.ID);
        retVal.add(nikoandcs.cards.Strike.ID);
        retVal.add(nikoandcs.cards.Strike.ID);
        retVal.add(nikoandcs.cards.Defend.ID);
        retVal.add(nikoandcs.cards.Defend.ID);
        retVal.add(nikoandcs.cards.Defend.ID);
        retVal.add(nikoandcs.cards.Defend.ID);
        retVal.add(nikoandcs.cards.Positioning.ID);
        retVal.add(nikoandcs.cards.PreAim.ID);
