...
import nikoandcs.BasicMod;
import nikoandcs.util.CardStats;
import nikoandcs.util.TriFunction;
...
import static nikoandcs.util.GeneralUtils.removePrefix;
import static nikoandcs.util.TextureLoader.getCardTextureString;
